...
type menuStatus = {
  ...
  isCrosshairChecked: boolean,
  isSpeedLimitChecked: boolean,
...
const store = () => {
  ...
  function getDefaultSettings(): menuStatus {
    return {
      ...
      isCrosshairChecked: getLocalStorage("isCrosshairChecked", false),
      isSpeedLimitChecked: getLocalStorage("isSpeedLimitChecked", false),
      isCinematicNotifyChecked: getLocalStorage("isCinematicNotifChecked", true),
      isCompassFollowChecked: getLocalStorage("isCompassFollowChecked", false),
      ...
      isMapNotifyChecked: getLocalStorage("isMapNotifChecked", false),
      isOpenMenuSoundsChecked: getLocalStorage("isOpenMenuSoundsChecked", true),
      isOutCompassChecked: getLocalStorage("isOutCompassChecked", false),
      isOutMapChecked: true,
      ...
      isShowCompassChecked: getLocalStorage("isShowCompassChecked", false),
      ...
      isToggleMapShapeChecked: getLocalStorage("isToggleMapShapeChecked", "square"),
    }
  }
    ...
    sendMenuSettingsToClient() {
      update(state => {
        fetchNui("updateMenuSettingsToClient",
        {
          ...
          "isCrosshairChecked": state.isCrosshairChecked,
          "isSpeedLimitChecked": state.isSpeedLimitChecked,
